...
const inputTextareaTemplate1 = (rowData, { rowIndex }) => <p >{rowData.stuName}</p>
const calendarTemplate2 = (rowData, { rowIndex }) => <p>{new Date(rowData.DOB).toLocaleDateString()}</p>
const dropdownTemplate3 = (rowData, { rowIndex }) => <p >{rowData.courseID?.courseID}</p>
...
<Column field="stuName" header="StuName" body={inputTextareaTemplate1} filter={selectedFilterFields.includes("stuName")} hidden={selectedHideFields?.includes("stuName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="DOB" header="DOB" body={calendarTemplate2} filter={selectedFilterFields.includes("DOB")} hidden={selectedHideFields?.includes("DOB")}  sortable style={{ minWidth: "8rem" }} />
<Column field="courseID" header="CourseID" body={dropdownTemplate3} filter={selectedFilterFields.includes("courseID")} hidden={selectedHideFields?.includes("courseID")}  style={{ minWidth: "8rem" }} />
